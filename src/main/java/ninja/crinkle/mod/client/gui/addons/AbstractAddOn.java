...
public abstract class AbstractAddOn extends AbstractScreen {
    ...
    protected AbstractAddOn(Class<? extends Screen> screenClass) {
        super(Component.literal(screenClass.getSimpleName() + "AddOn"), ClientUtil.screenWidth(),
                ClientUtil.screenHeight());
    ...
    public void onScreenMouseClickedPre(InputEvent.MouseButton.Pre event) {
        ...
        if (ClientUtil.getMinecraft().screen == null || ClientUtil.getMinecraft().screen.getClass() != screenClass())
            return;
