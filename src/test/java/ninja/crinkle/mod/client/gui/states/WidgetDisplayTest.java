...
class WidgetDisplayTest {
    ...
    class ConstructorTests {
        ...
        void testConstructorAlphaLessThanZero_Exception() {
            ...
            assertEquals("Alpha must be between 0 and 1", exception.getMessage(), "Unexpected exception message for invalid alpha.");
        }
        ...
        void testConstructorZIndexNegative_Exception() {
            ...
            assertEquals("Z-Index must be greater than or equal to 0", exception.getMessage(), "Unexpected exception message for invalid Z-index.");
        }
    }
