...
public class WidgetBehaviorTest {
    ...
    void shouldReturnCorrectToStringRepresentation() {
        ...
        String expected = "WidgetBehavior{draggable=true, dragged=true, pressed=false, focused=false, hovered=true, " +
                "active=false, focusable=true, highlightable=false, pressable=true, repositionable=false}";
    ...
    class WithDraggableTests {
        ...
        void shouldCreateWidgetBehaviorWithDraggableFalse() {
            ...
            assertAll(
                    ...
                    () -> assertEquals(original.focusable(), updated.focusable(), "Focusable state should remain " +
                            "unchanged"),
                    () -> assertEquals(original.hoverable(), updated.hoverable(), "Hoverable state should remain " +
                            "unchanged"),
                    () -> assertEquals(original.pressable(), updated.pressable(), "Pressable state should remain " +
                            "unchanged")
            );
        }
        ...
        void shouldThrowExceptionForInvalidDraggedState() {
            WidgetBehavior original = new WidgetBehavior(false, false, false, false, false, false, false, false,
                    false, false);
    ...
    class WithDraggedTests {
        ...
        void shouldCreateWidgetBehaviorWithDraggedTrue() {
            ...
            assertAll(
                    ...
                    () -> assertEquals(original.draggable(), updated.draggable(), "Draggable state should remain " +
                            "unchanged"),
                    () -> assertEquals(original.pressed(), updated.pressed(), "Pressed state should remain unchanged"),
                    () -> assertEquals(original.focused(), updated.focused(), "Focused state should remain unchanged"),
                    () -> assertEquals(original.hovered(), updated.hovered(), "Hovered state should remain unchanged"),
